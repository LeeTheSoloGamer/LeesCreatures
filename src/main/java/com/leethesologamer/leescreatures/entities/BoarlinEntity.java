...
public class BoarlinEntity extends TameableEntity implements IAngerable, IAnimatable{
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new BuckingGoal());
        this.goalSelector.addGoal(3, new TamedAiRide(this, 1.1D));
        this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1.1D, 10.0F, 2.0F, false));
        this.goalSelector.addGoal(5, new FollowParentGoal(this, 0.3));
        ...
        this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, BeastDogEntity.class,6.0F, 1.1D, 1.2D));
        this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, CrystalWyvernEntity.class,6.0F, 1.1D, 1.2D));
        this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, JungleSerpentEntity.class,6.0F, 1.1D, 1.2D));
        this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, CrestedCrikestreakerEntity.class,6.0F, 1.1D, 1.2D));
